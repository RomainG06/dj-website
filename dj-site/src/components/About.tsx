                ...
                <div className="about-content">
                    ...
                    <div className="about-text">
                        ...
                        <div className="about-description">
                            ...
                            <p>
                                Diazmantes est un artiste passionné qui façonne les nuits avec son style unique
                            ...
                            <p>
                                ...
                                Diazmantes crée des atmosphères uniques qui transportent son public dans
                                un voyage sonore inoubliable.
                            </p>

                            <h3 className="about-subtitle">Performances</h3>
                            <p>
                                Reconnu pour ses sets énergiques et sa capacité à lire la foule, Diazmantes
                            ...
                            <p>
                                Pour Diazmantes, la musique est bien plus qu'un métier - c'est une passion,
